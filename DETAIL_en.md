    ...
    └── gui-tauri/                   ★ The shell. Depends on fuseforks-core
        ...
        └── src/
            ...
            └── components/
                ...
                ├── FirstRunTour.vue                   First-launch guide (nine steps; shown only in an empty village; replay from Settings > General > Guide)
...
| Page | Content |
|---|---|
| General | **User** (your own name and icon), language (Japanese / English), and **Guide** (replay the nine-step walkthrough shown on first launch). The language is inferred from the OS on first launch only; never re-inferred afterwards |
